...
type Reading = { key: 'FR'|'PS'|'SR'|'GSP', title: string, html: string, textPlain: string }
type Data =
  | { ok: true, source: 'Evangelizo', date: string, titleLiturgic?: string, readings: Reading[], comment?: { title: string, html: string, textPlain: string } }
